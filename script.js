...
// const Observers = new IntersectionObserver(obsCallback, obsOption);
...
document.addEventListener('DOMContentLoaded', function(e) {
  console.log('Html downloaded and DOM tree built!', e);
})
